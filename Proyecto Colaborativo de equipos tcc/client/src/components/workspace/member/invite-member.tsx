  ...
  const handleCopy = () => {
    if (inviteUrl) {
      navigator.clipboard.writeText(inviteUrl).then(() => {
        ...
        toast({
          title: "Copiado",
          description: "url de invitacion copiado",
          variant: "success",
        });
  ...
  return (
    <div className="flex flex-col pt-0.5 px-0 ">
      <h5 className="text-lg  leading-[30px] font-semibold mb-1">
        Inivitar miembros a unirse 
      </h5>
      <p className="text-sm text-muted-foreground leading-tight">
        Cualquier persona con un enlace de invitación puede unirse a este espacio de trabajo gratuito. También puedes
        desactivar y crear un nuevo enlace de invitación para este espacio de trabajo en cualquier momento..
      </p>
